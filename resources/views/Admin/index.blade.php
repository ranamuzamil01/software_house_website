...
<head>
    ...
    <!-- Favicons -->
    {{-- <link href="assets/img/softwebies-icon.png" rel="icon"> --}}
    <link rel="icon" href="{{ asset('assets/img/softwebies-icon.png') }}">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ url('/admin') }}" class="logo d-flex align-items-center">
                ...
                {{-- <img src="assets/img/softwebies-icon.png" alt="">
                <span class="d-none d-lg-block">Softwebies</span> --}}
            </a>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="service" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{ url('/service-insert') }}">
                            <i class="bi bi-circle"></i><span>Service Insert</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ url('/view-service') }}">
